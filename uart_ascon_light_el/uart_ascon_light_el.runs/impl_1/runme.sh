...
HD_PWD='D:/formation_2025/digital_design/uart_ascon/uart_ascon.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inter_spartan.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inter_spartan.tcl -notrace
