...
HD_PWD='D:/formation_2025/digital_design/uart_ascon/uart_ascon.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inter_spartan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inter_spartan.tcl
