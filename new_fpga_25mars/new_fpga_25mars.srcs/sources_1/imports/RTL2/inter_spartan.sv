...
//  logic en_cpt_mux_s;
 ...
 clk_wiz_0 clock_0
  (
  .clk_out1(clock_s),      
  .reset(reset_i), //actif � l'�tat haut !!!
  //.locked(locked),
  .clk_in1(clock_i)
  );
...
ila_0 ila_inst_0 (
	...
	.probe2(key_s), // input wire [127:0]  probe2 
	.probe3(nonce_s), // input wire [127:0]  probe3 
	.probe4(ad_s), // input wire [63:0]  probe4 
	.probe5(start_ascon_s) // input wire [0:0]  probe5
);
